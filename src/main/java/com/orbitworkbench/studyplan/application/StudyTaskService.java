...
import com.orbitworkbench.studyplan.api.StudyTaskDtos.CreateTaskRequest;import com.orbitworkbench.studyplan.api.StudyTaskDtos.TaskResponse;
...
public class StudyTaskService {
    ...
    public TaskResponse create(Long userId, CreateTaskRequest request) {
        ...
        record.setPriority(StudyTaskPriority.valueOf(request.priority()));
